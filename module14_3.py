...
async def get_buying_list(message):
    with open('0220.jpg', 'rb') as img:
        await message.answer(f'Название: Product1 | Описание: описание 1 | Цена: 100p')
        await message.answer_photo(img)
    with open('1224.jpg', 'rb') as img:
        await message.answer(f'Название: Product2 | Описание: описание 2 | Цена: 200p')
        await message.answer_photo(img)
    with open('1225.jpg', 'rb') as img:
        await message.answer(f'Название: Product3 | Описание: описание 3 | Цена: 300p')
        await message.answer_photo(img)
    with open('11224.jpg', 'rb') as img:
        await message.answer(f'Название: Product4 | Описание: описание 4 | Цена: 400p')
        await message.answer_photo(img)
